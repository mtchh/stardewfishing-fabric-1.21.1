...
public class FishBehaviorReloadListener extends SimplePreparableReloadListener<Map<String, JsonObject>> implements IdentifiableResourceReloadListener {
    ...
    private static final ResourceLocation LOCATION = ResourceLocation.parse(StardewfishingFabric.MODID + ":data.json");
    ...
    public ResourceLocation getFabricId() {
        return ResourceLocation.parse(StardewfishingFabric.MODID + ":fish_behavior_reload");
    }
